...
<section class="content-wrap">
  ...
  <div class="youplay-banner banner-top youplay-banner-parallax small">
    <div class="image" style="background-image: url('assets/images/yg.jpg'); opacity:1">
    </div>
  ...
  <section class="youplay-banner youplay-banner-parallax small">
    <div class="image" style="opacity:.99 ;background-image: url('assets/images/yg2.jpg');">
    </div>
      ...
      <div>
        ...
        if (isset($loggedUser)) {
          ...
          if ($loggedUser->admin == '1'){
            echo '<a  class="btn btn-lg" href="?page=tournamentCreate&game=yugioh"><b>Create Tournament</a>';
          } 
} else {
